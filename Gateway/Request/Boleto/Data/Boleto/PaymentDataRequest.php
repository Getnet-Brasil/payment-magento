...
namespace Getnet\PaymentMagento\Gateway\Request\Boleto\Data\Boleto;
...
/**
 * Class Payment Data Request - Payment data structure for boleto.
 */
class PaymentDataRequest implements BuilderInterface
{
    ...
    {
        $instruction = [];
        $instruction[BoletoInitSchemaDataRequest::DATA][self::METHOD] = [
